...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "SV Industries fans have been an excellent choice for our residential projects. Their energy efficiency and quiet operation have been greatly appreciated by our clients.",
  ...
  },
  {
    ...
    quote:
      "We've installed SV ceiling fans throughout our restaurant, and they've been performing flawlessly for years. Great quality, stylish design, and excellent air circulation.",
  ...
  },
  {
    ...
    quote:
      "The industrial exhaust fans from SV Industries have significantly improved air quality in our manufacturing plant. Reliable products backed by excellent customer service.",
  ...
  },
  {
    ...
    quote:
      "SV Industries offers a perfect blend of functionality and aesthetics. Their ceiling fans complement my interior designs while providing excellent performance.",
                ...
                <div key={testimonial.id} className="w-full flex-shrink-0 px-4">
                  <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-8 relative">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-lg mb-6 italic text-blue-100">
                        "{testimonial.quote}"
                      </p>
